<?php
// contao/dca/tl_invoices.php
use Contao\DC_Table;

$GLOBALS['TL_DCA']['tl_invoices'] = [
    'config' => [
    ...
    'fields' => [
        ...
        (
                ...
                'filter'                  => true,
                'search'                  => true,
                'foreignKey'              => "tl_paymentCategory.category",                                          
    ...
    'palettes' => [
        'default' => '{maintenance_legend},invoiceNo,invoiceDate;category,payment;note'
    ],
];