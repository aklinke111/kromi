...
$sql_statement = "Select supplier,name,supplierArticleNo,sortlyId,round(bomPrice,2) as bomPrice,round(price,2) as price,quantityStock as stock,quantityNeeded as needed,quantityOrdered as orderd, quantity as purchase, ivm as IVM from bomCalculations where toOrder = 1 and ivm = 0";
