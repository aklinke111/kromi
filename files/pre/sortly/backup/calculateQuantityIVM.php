...
//        echo calculateTotalNeededQuantity($db);
        ...
        echo calculateDeinstalledQuantity($db);
        echo "<p>";  
...
function calculateDeinstalledQuantity($db){
    $msg = "";
    ...
    while($item = $result->fetch_assoc()){ 
        ...
        $quantity = $item['quantity'];
            ...
            // Update table
            $sql_1 = "UPDATE tl_sortlyTemplatesIVM SET quantityDeinstallations = $quantity WHERE id = $id";
            $result_1 = $db->query($sql_1);
            
        $msg.= "$model (ID $id) updated with quantity $quantity total deinstalled over period of $Period_Passed_Installations months <br/>";
    } 
    return $msg;
}
