...
$i=0;
$sql = "TRUNCATE TABLE tl_country";
echo $result = $db->query($sql);

$sql = "TRUNCATE TABLE tl_subsidiary";
echo $result = $db->query($sql);

$sql = "TRUNCATE TABLE tl_customers";
echo $result = $db->query($sql);

$sql = "TRUNCATE TABLE tl_storage";
echo $result = $db->query($sql);
                ...
                //$allContent.= $content."<br>"."<<".$i.">>".$row[name].' --- '.$row[parent_id].' --- '.$row[self_id];
                    ...
                    switch ($i) {
                        ...
                        case 1: //country
                                ...
                                $sql = "INSERT INTO tl_country (tstamp, self_id, parent_id, name) VALUES ('".time()."','$self_id','$parent_id','$name')";
                                $db->query($sql);
                            }
                            break;
                        case 2: //subsidiary
                            if($parent_id <> '70900463' AND strpos($name, '[') === false){
                                $sql = "INSERT INTO tl_subsidiary (tstamp, self_id, parent_id, name) VALUES ('".time()."','$self_id','$parent_id','$name')";
//                                echo $sql."<br>";
                                $db->query($sql);
                            }
                            break;
                        case 3: //customers
                            if($parent_id <> '70900630' AND $parent_id <> '70900631' AND strpos($name, '[') === false){
                                $sql = "INSERT INTO tl_customers (tstamp, self_id, parent_id, name) VALUES ('".time()."','$self_id','$parent_id','$name')";
//                                echo $sql."<br>";
                                $db->query($sql);
                            }
                            break;
                        case 4: //subsidiary
                                if(strpos($name, '[') === false){
                                $sql = "INSERT INTO tl_storage (tstamp, self_id, parent_id, name) VALUES ('".time()."','$self_id','$parent_id','$name')";
//                                echo $sql."<br>";
                                $db->query($sql);
                            }
                            break;   
