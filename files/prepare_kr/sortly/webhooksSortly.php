...
$title = "Mail von import.kromiag.de/sortly/webhook.php";
...
// write log
writeLog($referrer.'/'.$currentUrl, 'WEBHOOK', $msgbody, $db);
...
//include_once $_SERVER['DOCUMENT_ROOT']."/files/prepare_kr/sortly/sortlyToMySQL.php";
include_once "sortlyToMySQL.php";

echo $msgbody;

//http://import.kromiag.de/sortly/webhook.php
