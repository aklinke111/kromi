...
if (isset($_GET['webhookFunction'])) {
    ...
    if($function == "financeAllocations"){
...
function fillTable($db, $tableName){
    ...
    $sql = "Select
        ...
        'NA' As Currency,
        Count(sortly.sortlyId) As Quantity
    From
...
//            $Quantity = 1;
            ...
            executeQuery($db,$tableName,$Version,$Period,$CostObject,$costcenter,$KTCID,$Item,$Currency,1);
        } 
...
function tableToCSV($db, $tableName){
    ...
    $backupFilePath = $_SERVER['DOCUMENT_ROOT']."/files/prepare_kr/finance/BackupFiles/KTC_Allocations/";
