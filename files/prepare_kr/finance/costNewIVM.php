...
function costNewIVM($db, $id, $forecastDate, $regionId){
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if($db->query($sql)){
        $msg .= "Monthly cost for KTC-Implementation in region '$regionName' of $totalPerMonth € for forecast date $forecastDate and forecast period of $ForecastPeriod months inserted successfully in table 'kr_forecastEngineering'<p>";
        }
    }
