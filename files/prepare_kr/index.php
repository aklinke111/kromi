...
<body>
    <div class="form-container">
        ...
        <div class="button-container">
            ...
            <button onclick="submitForm('financeAllocations')">
                <i class="fas fa-exclamation-circle button-icon"></i>
                <span>F1 - Controlling Report JEDOX to CSV</span>
            </button>            
            <button onclick="submitForm('financeBomExcel')">
                <i class="fas fa-exclamation-circle button-icon"></i>
                <span>F2 - KTC production 1/2 BY to Excel</span>
            </button>
            <button onclick="submitForm('financeForecastExcel')">
                <i class="fas fa-exclamation-circle button-icon"></i>
                <span>F3 - Forecast 24 to Excel</span>
            </button>  
